    ...
    <>
      <style>{`
        ...
        .hero-action.blueprint {
          ...
          background-size: 18px 18px; border-color: var(--teal-dark);
        }
        .hero-eyebrow { font-family: 'Space Mono', monospace; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.09em; margin-bottom: 6px; }
        ...
        .ledger-table td { padding: 16px; border-bottom: 1px dashed var(--line); font-size: 13.5px; color: var(--ink-2); vertical-align: middle; }
        ...
        .inst-card { display: flex; flex-direction: column; gap: 10px; padding: 16px 20px; border-bottom: 1px dashed var(--line); }
      ...
      <div className="credit-gauge-card">
        ...
        {kycStatus === 'verified' && availableCredit > 0 && (
          <div className="flex items-center justify-between gap-3 flex-wrap mt-5 pt-5" style={{ borderTop: '1px dashed var(--line-md)' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
                    ...
                    {installments.map((inst) => {
                      ...
                      return (
                        <tr key={inst.id} style={{ background: isNext ? 'var(--marigold-bg)' : 'transparent' }}>
                          ...
                          <td>
                            {isPaid ? (
                              <span className="stamp flat" style={{ fontSize: 10, padding: '2px 6px', color: 'var(--teal-dark)', borderColor: 'var(--teal)', background: 'var(--teal-bg)' }}>✓ Paid</span>
                            ) : isOver ? (
                              <span className="stamp flat" style={{ fontSize: 10, padding: '2px 6px', color: 'var(--magenta)', borderColor: 'var(--magenta)', background: 'var(--magenta-bg)' }}>Overdue</span>
                            ) : isNext ? (
                              <span className="stamp flat" style={{ fontSize: 10, padding: '2px 6px', color: 'var(--marigold-dark)', borderColor: 'var(--marigold-dark)', background: '#FFF' }}>Due Next</span>
                            ) : (
          ...
          <div className="ledger-card overflow-hidden">
            ...
            <div className="px-6 py-4 flex items-center justify-between" style={{ borderBottom: '1.5px solid var(--line)' }}>
              ...
              <Link href="/payments" className="text-xs font-mono font-bold uppercase tracking-wider" style={{ color: 'var(--teal)' }}>See all</Link>
            </div>
        ...
        {/* Right Column (1 Span): Quick Access & Trust Perks */}
        <div className="flex flex-col gap-8">
          ...
          <div className="ledger-card overflow-hidden">
            ...
            <div className="sidebar-nav">
              {activeLoan ? (
                <Link href={`/loans/${activeLoan.id}`} className="sidebar-nav-item">
                  <div className="flex items-center gap-3">
                    <span className="sidebar-nav-icon">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M3 3v18h18" /><path d="M18.7 8.3l-5.2 5.2-3-3-4.5 4.5" />
                      </svg>
                    </span>
                    <div>
                      <span className="sidebar-nav-label">Current loan</span>
                      <span className="sidebar-nav-sub">#{activeLoan.id.slice(0, 8)} · {activeLoan.status}</span>
                    </div>
                  </div>
              ...
              <Link href="/payments" className="sidebar-nav-item">
                <div className="flex items-center gap-3">
                  <span className="sidebar-nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div>
                    ...
                    <span className="sidebar-nav-sub">{recentPayments?.length ?? 0} recent</span>
                  </div>
                </div>
                <span style={{ color: 'var(--ink-4)' }}>→</span>
              </Link>
