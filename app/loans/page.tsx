...
export default async function LoansPage({
  ...
  const openLoans      = enriched.filter(e => ['approved', 'disbursed', 'active', 'overdue'].includes(e.loan.status))
              ...
              {visibleLoans.length === 0 ? (
                ...
                <div className="ledger-card overflow-hidden">
                  ...
                  {visibleLoans.map(({ loan, insts, outstanding, paidCount, nextInstallment }) => {
                    ...
                    const canQuickPay = ['active', 'disbursed', 'overdue'].includes(loan.status) && !!nextInstallment
